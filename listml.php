...
<body>
    ...
    <div class="slideshow-container">
        ...
        <div class="slideshow" id="slideshow">
            <img src="image/ml1.jpeg" alt="Slide 1" class="slide">
            <img src="image/ml6.jpeg" alt="Slide 2" class="slide">
            <img src="image/ml3.jpeg" alt="Slide 3" class="slide">
            <img src="image/ml4.jpeg" alt="Slide 4" class="slide">
            <img src="image/ml6.jpeg" alt="Slide 5" class="slide">
        </div>
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <div class="container" data-skin="' . $row['skin'] . '" data-level="' . $row['level'] . '" data-price="' . $row['price'] . '">
                <div class="image-gallery">
                    <img src="ADMIN/admin/gambarAkunMl/' . basename($row['preview_image']) . '" alt="Screenshot ' . $row['id'] . '" width="200">
                </div>
