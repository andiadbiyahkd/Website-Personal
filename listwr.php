...
<head>
    ...
    <style>
        body {
            ...
            color: #333;
            background: url('image/wildrift.jpeg') no-repeat center center fixed;
...
<body>
    ...
    <div class="slideshow-container">
        ...
        <div class="slideshow" id="slideshow">
            <img src="image/wr1.jpeg" alt="Slide 1" class="slide">
            <img src="image/wr2.jpeg" alt="Slide 2" class="slide">
            <img src="image/wr3.jpeg" alt="Slide 3" class="slide">
            <img src="image/wr4.jpeg" alt="Slide 4" class="slide">
            <img src="image/wr5.jpeg" alt="Slide 5" class="slide">
        </div>
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <div class="container" data-skin="' . $row['skin'] . '" data-level="' . $row['level'] . '" data-price="' . $row['price'] . '">
                <div class="image-gallery">
                    <img src="ADMIN/admin/gambarAkunWr/' . basename($row['preview_image']) . '" alt="Screenshot ' . $row['id'] . '" width="200">
                </div>
                <div class="product-details">
                    <h2>Produk Dari: ' . $row['penjual'] . '</h2>
                    <p>Jumlah Skin: ' . $row['skin'] . '</p>
                    <p>Jumlah Champion:'.$row['hero']. '</p>
                    <p>Level: ' . $row['level'] . '</p>
